...
const doc = parser.parseFromString(optionsListContainer.innerHTML, 'text/html');
...
const input = label!.querySelector('input#apple[data-dynamic-typeahead][type="radio"][value="apple"]');
